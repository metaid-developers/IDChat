...
import { nextTick, onBeforeUnmount, onUnmounted, watch,computed } from 'vue'
...
import SubChannelContent from './SubChannelContent.vue'
...
const activeChannelId = computed(() => {
  return talk.activeChannel?.subChannels[0]?.channelId || talk.activeSubChannel?.channelId
})
